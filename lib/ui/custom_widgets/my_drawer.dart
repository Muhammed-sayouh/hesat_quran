              ...
              children: [
                ...
                DrawerItem(
                  ...
                  title: Constants.voiceQuran,
                   onTap:()=> Get.to(()=>const AudioQuran(),transition: Transition.downToUp),
                ),
                DrawerItem(
                  image: Constants.readingIcon,
                  title: Constants.countineReading,
                   onTap:()=> Get.to(()=>const ContinueReadingScreen(),transition: Transition.downToUp),

                ),
                DrawerItem(
                  image: Constants.missionsIcon,
                  title: Constants.missions,
                   onTap:()=> Get.to(()=>const MissionsScreen(),transition: Transition.downToUp),
